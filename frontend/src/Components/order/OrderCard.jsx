...
import { removeOrderAPi } from '../../redux/actions/orderAction';
    ...
    const handleCancelOrder = (productId) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                dispatch(removeOrderAPi(productId));  
            }
          })
    }
                ...
                <Card.Body>
                    <div className='row'>
                        ...
                        <div className="mt-3 d-flex justify-content-between">
                            <button
                                className="w-100 actionbtn bg-danger px-5 p-2 text-white"
                                variant="danger"
                                onClick={() => handleCancelOrder(obj._id)}
                            >
                                Cancel Order
                            </button>
                        </div>
